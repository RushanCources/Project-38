...
class AnnouncementForm(forms.Form):
    ...
    title = forms.CharField(label='', required=True, widget=forms.Textarea(attrs={'class': 'label-textarea', 'placeholder' : 'Заголовок объявления', 'onkeyup' : 'textarea_size(this)', 'cols' : 'none', 'rows' : 'none'}))
